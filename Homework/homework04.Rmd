...
## Chick weights
#### Due: 10/16/2018 before 11pm. Submit in Canvas (file upload).
...
10 pts of extra credit: construct a ggplot that shows average weights by diet with an interval (shown as a line) of +- the standard deviation around the averages.
